            ...
            <div className="text-center">
              ...
              <p>
                {isEmpty(profile.website) ? null : (
                  <a className="text-info p-2" href={profile.website} target="_blank">
                ...
                {isEmpty(profile.social && profile.social.facebook) ? null : (
                  <a className="text-info p-2" href={profile.social.facebook} target="_blank">
                    <i className="fab fa-facebook fa-2x"></i>
                  </a>
                )}
                {isEmpty(profile.social && profile.social.linkedin) ? null : (
                  <a className="text-info p-2" href={profile.social.linkedin} target="_blank">
                    <i className="fab fa-linkedin fa-2x"></i>
                  </a>
                )}
                {isEmpty(profile.social && profile.social.instagram) ? null : (
                  <a className="text-info p-2" href={profile.social.instagram} target="_blank">
